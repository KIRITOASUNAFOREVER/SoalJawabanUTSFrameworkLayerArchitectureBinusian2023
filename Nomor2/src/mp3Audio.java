...
public class mp3Audio extends AdditionalCard{

	@Override
	public void canRead() {
		System.out.println("MP3 Audio Berhasil Membaca");
	}

	@Override
	public void canWrite() {
		System.out.println("MP3 Audio Berhasil Menulis");
	}

	@Override
	public void cardBehaviour() {
		System.out.println("Memainkan Format Audio Mp3");
	}

	@Override
	public void addCard(String mp3Audio, ArrayList<ComputerSlot> cS, int papanEkstensi) {
		if(canFitInSlot(null) ==true) {
			...
			if(hitung <=3 && papanEkstensi==1) {
				System.out.println("Berhasil Insert Mp3 Audio dengan Nama "+mp3Audio);
				if(cS.size()==0) {
					cS.add(new ComputerSlot("", "", "", "", mp3Audio,0 , 0, 5));
					System.out.println();
				}else {
					cS.add(new ComputerSlot("", "", "", "", mp3Audio,0 , 0, 5));
					System.out.println();
