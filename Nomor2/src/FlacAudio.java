...
public class FlacAudio extends AdditionalCard{

	@Override
	public void canRead() {
		System.out.println("Flac Audio Berhasil Membaca");
	}

	@Override
	public void canWrite() {
		System.out.println("Flac Audio Berhasil Menulis");
	}

	@Override
	public void cardBehaviour() {
		System.out.println("Memainkan Format Audio Flac");
	}

	@Override
	public void addCard(String FlacAudio, ArrayList<ComputerSlot> cS, int papanEkstensi) {
		if(canFitInSlot(null) ==true) {
			...
			if(hitung <=3 && papanEkstensi==1) {
				System.out.println("Berhasil Insert Flac Audio dengan Nama "+FlacAudio);
				if(cS.size()==0) {
					cS.add(new ComputerSlot("", "", "", "", FlacAudio,0 , 0, 5));
					System.out.println();
				}else {
					cS.add(new ComputerSlot("", "", "", "", FlacAudio,0 , 0, 5));
					System.out.println();
